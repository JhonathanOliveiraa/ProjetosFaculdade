...
double VetorAleatorio::medicaoSelectionSort()
{
    clock_t tempoInicial = clock();
    selectionSort();
    clock_t tempoFinal = clock();
    double tempoDeResposta = (tempoFinal - tempoInicial) / static_cast<double>(CLOCKS_PER_SEC) * 1000;
    return tempoDeResposta;
}

double VetorAleatorio::medicaoInsertionSort()
{
    clock_t tempoInicial = clock();
    insertionSort();
    clock_t tempoFinal = clock();
